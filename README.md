...
SPA móvil de solo lectura con la tarjeta de consulta de hombro (Banderas rojas, Bisagra y árbol, fichas de síndrome y diferencial de rigidez). El inicio es un selector de región; hoy solo hombro tiene datos, las otras cuatro se ven pero están pendientes. No guarda datos.
