...
(async () => {
  ...
  ok(boton.getAttribute('title') === 'Mantener la pantalla encendida: desactivado', 'botón: title (tooltip en hover de escritorio) dice lo mismo que aria-label');
  boton.click();
  await wait(20);
  ...
  ok(boton.getAttribute('title') === 'Mantener la pantalla encendida: activado', 'al pulsar: title pasa a decir "activado" también');
